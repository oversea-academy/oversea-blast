  ...
  replaceMessage: (message, item, mode) => {
    return new Promise((resolve) => {
      if (mode == 'default') {
        ...
        const replaceName = module.exports.replaceName(message, item);
        const replaceStructure = module.exports.replaceTOEFL(
          replaceName,
          item,
          'structure'
        );
        const replaceReading = module.exports.replaceTOEFL(
          replaceStructure,
          item,
          'reading'
        );
        const replaceListening = module.exports.replaceTOEFL(
          replaceReading,
          item,
          'listening'
        );
        const replaceTotal = module.exports.replaceTOEFL(
          replaceListening,
          item,
          'total'
        );
